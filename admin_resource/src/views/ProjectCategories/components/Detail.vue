                    ...
                    <div class="block-header block-header-default">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><router-link :to="'/projectcategories'">{{$t("Project's category")}}</router-link></li>
        ...
        en: {
            custom:{
                name:{
                    ...
                    min: "Category's name must be at least 2 characters",
                    max:"Category's is too long"
                }
            }
        }
    };
    ...
    export default {
        ...
        computed: {
            ...
            slugRules: function(){
                if(this.locale == 'en'){
                    return [
                        v => v.length > 0 || 'Url connot be empty',
            ...
            notifySuccess: function() {
                if(this.locale == 'en') {
                    ...
                    return {
                        type: 'success',
                        icon: 'fa fa-success mr-1',
                        message: 'Lưu danh mục dự án thành công.'
                    }
                }
            },
        ...
        created() {
            if (this.isEdit) {
                const id = this.$route.params && this.$route.params.projectcategory;
                this.getData(id)
            } else {
