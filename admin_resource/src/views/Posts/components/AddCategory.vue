                              ...
                              <div class="row justify-content-center py-sm-3 py-md-5">
                                  <div class="col-sm-10 col-md-8">
                                      <div class="form-group">
                                          <label for="block-form9-username">Tên</label>
                                          <input v-validate="'required|min:1'" type="text"  v-model="editedItem.name" class="form-control form-control-alt" id="block-form9-username" name="name" placeholder="Nhập tên">
                                          <span class="text-danger">{{ errors.first('name') }}</span>
                                      </div>
                                      <div class="form-group">
                                          <label for="block-form8-username">Url</label>
                                          <input type="text" v-model="slug" class="form-control form-control-alt" id="block-form8-username" name="block-form8-username" placeholder="Nhập url">
                                      </div>
                                  </div>
                              </div>
                          </div>
...
<script>
import { updateApi, createApi } from '@/api/categories'
import Vue from 'vue';
...
export default {
  ...
  computed: {
    formTitle() {
      return this.editedIndex === -1 ? 'Tạo mới chuyên mục' : 'Sửa chuyên mục'
    },
    isEdit() {
