                    ...
                    <div class="block-header block-header-default">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><router-link :to="'/categories'">{{$t("Post's Category")}}</router-link></li>
                                <li class="breadcrumb-item active" aria-current="page" v-if="isEdit">{{$t("Edit Post's Category")}} / {{currentForm.name}}</li>
                                <li class="breadcrumb-item active" aria-current="page" v-else>{{$t("Create Post's Category")}}</li>
                    ...
                    <div class="block-content">
                        <div class="row justify-content-center py-sm-3 py-md-5">
                            <div class="col-sm-10 col-md-8">
                                ...
                                <div class="form-group">
                                    <label >{{$t("Post's Category Slug")}}</label>
...
<script>
    ...
    const dictionary = {
        ...
        en: {
            custom:{
                name: {
                    required: "Please entrt category's name",
                    min: "Category's name at least 6 characters",
                    max:"Caqtegory's name is too long"
                }
            }
        }
    };
            ...
            notifySuccess: function() {
                if(this.locale == 'en') {
                    ...
                    return {
                        type: 'success',
                        icon: 'fa fa-success mr-1',
                        message: 'Lưu chuyên mục bài viết thành công.'
                    }
                }
            },
