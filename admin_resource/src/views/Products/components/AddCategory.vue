                            ...
                            <div class="block-content">
                                <div class="row justify-content-center py-sm-3 py-md-5">
                                    <div class="col-sm-10 col-md-8">
                                        ...
                                        <div class="form-group">
                                            <label for="block-form10-username">Vị trí</label>
                                            <input v-validate="'required|numeric'" type="number" v-model="editedItem.order" class="form-control form-control-alt" id="block-form10-username" name="order" placeholder="Nhập vị trí">
...
<script>
    import { updateApi, createApi } from '@/api/productcategories'
    import Vue from 'vue';
    ...
    const dictionary = {
        vn: {
            custom:{
                ...
                order:{
                    required:'Vui lòng chọn vị trí',
                    numeric:'Vui lòng nhập số'
                }
            }
        }
    };
