<?php
namespace App\Http\Controllers\Admin\En;

use App\Http\Controllers\Controller;
use App\Models\ListSlide;
use App\Tables\Builders\Admin\ListSlideEnTable;
...
class ListSlideTableController extends Controller
{
    use Datatable;
    protected $tableClass = ListSlideEnTable::class;

    public function destroy(ListSlide $list_slide)
    {
        $list_slide->slides()->delete();
        $list_slide->delete();
        return [
