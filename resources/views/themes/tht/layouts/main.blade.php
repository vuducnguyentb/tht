...
<section class=" top-search-bar cbp-spmenu cbp-spmenu-horizontal cbp-spmenu-top">
    <div class="container">
        <div class="search-wraper">
            <form action="{{route('products.search')}}" method="get" name="s" class="navbar-form navbar-left" role="search">
                <div class="form-group">
                    <input type="text" class="input-sm form-full" placeholder="@lang('home.home_placeholder_product')..." name="s" />
                </div>
...
<!-- Site Wraper -->
<div class="wrapper">
@include('themes.tht.sections.header')

@yield('content')

@include('themes.tht.sections.footer')
<!-- Scroll Top -->
