...
@section('seo_support')
    <title>{{get_site_setting('services-cate-title') }}</title>
    <meta name="description" content="{{get_site_setting('services-cate-description') }}">
    <meta name="keywords" content="{{get_site_setting('services-cate-keywords') }}">
    <meta property="og:title" content="{{get_site_setting('services-cate-title') }}">
    <meta property="og:description" content="{{get_site_setting('services-cate-description') }}">
    ...
    <meta name="twitter:title" content="{{get_site_setting('services-cate-title') }}">
    <meta name="twitter:description" content="{{get_site_setting('services-cate-description') }}">
                        ...
                        <div class="service-item">
                            ...
                            <div class="info-service">
                                <div class="title-service">
                                    <a href="{{route('detail_services', ['slug' => $item->slug])}}"><h3>{{$item->title}}</h3></a>
                                </div>
                                <div class="date-service">
                                    <span>{{ \Carbon\Carbon::parse($item->created_at)->format('d/m/Y')}}</span>
                                    <span class="body-service">{{strip_tags($item->body)}}</span>
                                    <a href="{{route('detail_services', ['slug' => $item->slug])}}"
