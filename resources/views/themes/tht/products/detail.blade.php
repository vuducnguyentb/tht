...
@section('seo_support')
    ...
    @else
        <meta property="og:image" content="{{route('posts.detail',$productImageFist->image)}}">
    @endif
    <meta property="og:url" content="{{route('products.detail',$product->slug)}}">
    ...
    @else
        <meta property="twitter:image" content="{{route('posts.detail',$productImageFist->image)}}">
    @endif
								...
								<div class="prn accordion">
                                    ...
                                    @if($item->slug === $cate_with_type->slug)
                                            ...
                                            @foreach ($item->producttypes as $type2)
												...
												<p ><a href="/the-loai-san-pham/{{$type2->slug}}" class="active" >{{$type2->name}}</a></p>
                                                    @else
                                                        <p ><a href="/the-loai-san-pham/{{$type2->slug}}">{{$type2->name}}</a></p>
                                                    @endif
                                            @endforeach
											</div>
										</div>
										...
										<ul class="col-xs-12 widget-post">
                                            ...
                                            @foreach ($product_news as $item)
												<li>
													...
													<a href="/san-pham/{{$item->slug}}"> <h6>{{$item->name}} </h6></a>
													</div>
												</li>
											@endforeach
                                                @endif
...
{{--										<a class="cbox-gallary1" href="{{$item->image}}"><i class="fa fa-search-plus"></i>Zoom</a>--}}
{{--									</div>--}}
{{--									<!-- End Item zoom -->--}}
{{--							</div>--}}
{{--						</div>--}}
						...
						<div class="col-sm-9">
							<div class="row">
										<div class="tabs b-lrb-none">
											<ul>
												<li><a href="#tabs-01"><i class="ion ion-help-circled left"></i>Mô tả</a></li>
												<li><a href="#tabs-02"><i class="ion ion-help-buoy left"></i>Thông số kĩ thuật</a></li>
												<li><a href="#tabs-03"><i class="ion ion-ios-list left"></i>Tài liệu</a></li>
											</ul>
															...
															@if(count($catalogs) >0)
																<tbody>
																	<tr style="padding-bottom:5px;font-size:18px">
																		<td style="line-height:1.5;">Tên file</td>
																		<td style="line-height:1.5;">Tải xuống</td>
																	</tr>
																	@foreach ($catalogs as $item)
																	<tr>
																		<td style="line-height:1.5;">Hướng dẫn sử dụng</td>
																...
																@else
																		<div class="alert alert-info">
																				<strong>Thông báo ! </strong> Tài liệu của sản phẩm này hiện đang được cập nhật.
																		</div>
																@endif
															</table>
												</div>
