...
@section('seo_support')
    ...
    @else
        <meta property="og:image" content="{{route('posts.detail',$product_cate[0]['images']->first()['image'])}}">
    @endif
    <meta property="og:url" content="{{route('cate.product',$slug_cate[0]->slug)}}">
    ...
    @else
        <meta name="twitter:image" content="{{route('posts.detail',$product_cate[0]['images']->first()['image'])}}">
    @endif
@endsection
@section('after_css')
