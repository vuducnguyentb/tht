...
@section('seo_support')
    ...
    @if($project['projectimages'] != null && $project['projectimages']->first() != null)
        <meta property="og:image" content="{{route('posts.detail',$project['projectimages']->first()['image'])}}">
    @else
        <meta property="og:image" content="{{asset_theme ('img/logo.png')}}">
    @endif
    <meta property="og:url" content="{{route('detail_project',$project->slug)}}">
    ...
    @endif
    @if($project['projectimages'] != null && $project['projectimages']->first() != null)
        <meta name="twitter:image" content="{{route('posts.detail',$project['projectimages']->first()['image'])}}">
    @else
        ...
        <div class="row">
            ...
            <div class="col-lg-9 col-md-9 blog-post-hr">
                <div class="blog-post mb-30">
                    <div class="post-meta"><span> <a>THT - Việt Nam</a>,</span> <span>{{ \Carbon\Carbon::parse($project->created_at)->format('d/m/Y')}} </span></div>
            ...
            <div class="col-lg-3 col-md-3 mt-sm-30">
                ...
                <div class="post-author">
                        ...
                        <div class="post-author-details pull-left">
                            <h6>Chia sẻ</h6>
                            <ul class="social">
                                <li><a href="https://facebook.com/sharer/sharer.php?u={{route('detail_project',$project->slug)}}" target="_blank"><i class="fa fa-facebook"></i></a></li>
                                ...
                                <li><a href="https://plus.google.com/share?url={{route('detail_project',$project->slug)}}" target="_blank"><i class="fa fa-google-plus"></i></a></li>
                                ...
                                <li><a href="https://pinterest.com/pin/create/button/?url={{route('detail_project',$project->slug)}}&amp;media={{route('detail_project',$project->slug)}}&amp;description=C%C3%94NG%20TY%20CP%20TH%C6%AF%C6%A0NG%20M%E1%BA%A0I%20D%E1%BB%8ACH%20V%E1%BB%A4%20V%C3%80%20K%E1%BB%B8%20THU%E1%BA%ACT%20CAO%20THT" target="_blank"><i class="fa fa-pinterest"></i></a></li>
                            </ul>
                        </div>
                    </div>
            </div>
