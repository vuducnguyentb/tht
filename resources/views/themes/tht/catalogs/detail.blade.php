...
@section('seo_support')
    ...
    <meta name="description" content="{{get_site_setting('catalog-detail-description') }}">
    <meta name="description" content="{{Str::words($catalog->body,25,'...')}}">
    <meta name="keywords" content="{{get_site_setting('catalog-detail-keywords') }}">
    ...
    @endif
    <meta property="og:url" content="{{route('catalogs.detail',$catalog->slug)}}">
    <meta name="twitter:title" content="{{$catalog->name}}">
    <meta name="twitter:description" content="{{Str::words($catalog->body,25,'...')}}">
    @if($list[0]->link != null)
    <meta name="twitter:image" content="{{route('posts.detail',$list[0]->link)}}">
    @else
        ...
        <div class="container">
            <div class="row title">
                ...
                <div class="page-breadcrumb">
                    <a href="{{route('home')}}">Trang chủ</a>/<span>Tài liệu {{$catalog->name}}</span>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="col-lg-12">
                    <div class="catalog-info">
                        ...
                        <div class="download text-right">
                            <strong><span class="download-catalog">Tải tài liệu</span> </strong>
