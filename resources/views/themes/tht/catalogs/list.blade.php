...
@section('seo_support')
    <title>{{get_site_setting('catalog-list-title') }}</title>
    <meta name="description" content="{{get_site_setting('catalog-list-description') }}">
    <meta name="keywords" content="{{get_site_setting('catalog-list-keywords') }}">
    <meta property="og:title" content="{{get_site_setting('catalog-list-title') }}">
    <meta property="og:description" content="{{get_site_setting('catalog-list-description') }}">
    @if($list[0] != null && $list[0]->link != null)
        <meta property="og:image" content="{{route('posts.detail',$list[0]->link)}}">
    @else
        <meta property="og:image" content="{{asset_theme ('img/logo.png')}}">
    @endif
    <meta property="og:url" content="{{route('catalogs')}}">
    <meta name="twitter:title" content="{{get_site_setting('catalog-list-title') }}">
    <meta name="twitter:description" content="{{get_site_setting('catalog-list-description') }}">
    <meta name="twitter:card" content="summary_large_image">
    @if($list[0] != null && $list[0]->link != null)
    <meta name="twitter:image" content="{{$list[0]->link}}">
    @else
    ...
    <section class="ptb ptb-sm-80">
        <div class="container text-center">
            <div class="row">
                <div class="col-lg-4">
                    <div class="sidebar-widget">
                        <h5 class="text-left">Tìm kiếm tài liệu</h5>
                        <div class="widget-search">
                            <form action="{{route('catalogs.search')}}" method="get">
                                <input class="form-full input-lg" type="text" value="" placeholder="Vui lòng nhập" name="tukhoa" id="wid-search">
            ...
            <div class="row">
                ...
                @endforeach
                @else
                    <h2 class="text-center">Tài liệu đang được cập nhập</h2>
                    @endif
                    <div class="col-sm-12">
