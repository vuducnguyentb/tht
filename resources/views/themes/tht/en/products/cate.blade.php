...
@section('seo_support')
    ...
    @if($product_cate[0] == null || $product_cate[0]['images'] == null || $product_cate[0]['images']->first()['image'] == null)
        <meta property="og:image" content="{{asset_theme ('img/logo.png')}}">
    @else
        <meta property="og:image" content="{{route('posts.detailEn',$product_cate[0]['images']->first()['image'])}}">
    @endif
    <meta property="og:url" content="{{route('cate.productEn',$slug_cate[0]->slug)}}">
    ...
    @else
        <meta name="twitter:image" content="{{route('posts.detailEn',$product_cate[0]['images']->first()['image'])}}">
    @endif
@endsection
@section('after_css')
            ...
            <div class="row sli">
                    ...
                    <div class="col-sm-9 bread">
                            <nav aria-label="breadcrumb" style="font-size: 16px;">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item">{{$slug_cate[0]->name}}</li>
                                    </ol>
                            </nav>
                    </div>
                </div>
            <div class="row">
                ...
                <div  class="col-sm-9 col-md-9">
                        <div class="row container-grid">
                            ...
                            @if ($count == 0 || count($product_cate) == 0)
