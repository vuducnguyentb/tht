	...
	<div class="container">
		<div class="row">
			<div class="col-sm-6 col-sm-4">
					<a href="{{route('postEn')}}"><h2 id="post">{{__('Post')}}</h2></a>
			</div>
			<div class="col-sm-6 col-sm-8 mb-30">
				<p class="lead">
					{!!strip_tags(\App\Helpers\Base::getSetting('intro-post-home-en'))!!}
				</p>
			</div>
		</div>
				...
				<div class="col-sm-4 mb-xs-30">
					<div class="blog-post">
						...
						<div class="post-header">
							<h4 id="tit" ><a style="color:black" href="{{route('posts.detailEn', ['slug' => $item->slug])}}">
		...
		<div class="row text-center">
			<div class="col-xs-12">
			<a class="btn btn-md btn-black mt-30" href="{{route('postEn')}}">{{__('See more')}}</a>
			</div>
		</div>
	</div>
</section>
