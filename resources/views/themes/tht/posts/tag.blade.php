    ...
    <meta name="description" content="{{get_site_setting('posts-tag-description') }}">
    <meta name="keywords" content="{{get_site_setting('posts-tag-keywords') }}">
@endsection
	@section('after_css')
	...
	<section class="inner-intro bg-img17 overlay-dark light-color parallax parallax-background2">
			<div class="container">
				<div class="row title">
					...
					<a href="{{route('home')}}">Trang chủ</a>/<a>Tin tức</a><span>
					</div>
				</div>
			</div>
		</section>
