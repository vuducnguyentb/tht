...
@section('seo_support')
    ...
    @endif
    @if($post->image != null)
        <meta property="og:image" content="{{route('posts.detail',$post->image)}}">
    @else
    ...
    @endif
    @if($post->image != null)
        <meta name="twitter:image" content="{{route('posts.detail',$post->image)}}   ">
    @else
                ...
                <div class="col-lg-9 col-md-9 blog-post-hr">
                    <div class="blog-post mb-30">
                        ...
                        <div class="post-header">
                            <h3 id="tit"><a href="{{route('posts.detail', ['slug' => $post->slug])}}">{{$post->title}}</a></h3>
                        </div>

                        <div class="post-media">

                        <a href="{{route('posts.detail', ['slug' => $post->slug])}}"> <img id="img-w" alt="" src="{{$post->image ?? ''}}"> </a>
                ...
                <div class="col-lg-3 col-md-3 mt-sm-30">
                            ...
                            <div class="sidebar-widget">
                                ...
                                <div class="widget-search">
                                    <form action="/tim-kiem2" method="get" name="s" role="search" >
                                        <input class="form-full input-lg" type="text"  placeholder="Tìm bài viết" id="search" name="s">
                                    </form>
                                </div>
                            </div>
                    ...
                    <div class="sidebar-widget">
                        ...
                        <ul class="widget-post">
                            ...
                            <li>
                                    <a href="{{route('posts.detail', ['slug' => $post->slug])}}" class="widget-post-media">
                                        @if(!empty($item->image))
                                    ...
                                    <p><a href="{{route('posts.detail', ['slug' => $item->slug])}}">{!! Str::words($item->title, 13,'....')  !!}</a></p>
